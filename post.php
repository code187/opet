...
if ($ak=="7")
{
	...
	$rez = mysql_query($a) or die("<span class=podnaslovi_crveni>GREŠKA: pozivanja tablice postova foruma!</span>");
		...
		if ($pta_tko == $user or $prava_postavke=="3")
			{
				...
				$rez = mysql_query($a) or die("<span class=podnaslovi_crveni>GREŠKA: brisanja postova foruma!</span>");
				echo "<b>Komentar uspješno obrisan!</b><br>";
			}
}
//snimi post
if ($ak=="2")
...
<br>
<table id=tablica_lijevop><tr class=alt><td width=70%><b><p align=center>Komentar</p></b></td><td width="10%"><b><p align=center>Vrijeme</p></b></td><td><b><p align=center>Pošiljatelj</p></b></td></tr></table>
